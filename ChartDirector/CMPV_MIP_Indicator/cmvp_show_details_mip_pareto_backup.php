...
$sql_Str="
 ...
 and \"Clean_Lab_Name\"  like '%".$new_xLabel."%'".$where_vendor.$where_security.$where_MT."  order by time_in_mip 
...
echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?in_IntelOnlyButton=".$in_IntelOnlyButton."&in_SecurityLevelButton=".$in_SecurityLevelButton."&in_ModuleTypeButton=".$in_ModuleTypeButton."&xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=1&Direction=".$Direction." \" >Cert</a></th>  ";


echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=2&Direction=".$Direction." \" >Module</a></th>  ";


echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=3&Direction=".$Direction." \" >Vendor</a></th>  ";


echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=4&Direction=".$Direction." \" >Lab</a></th>  ";

echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=6&Direction=".$Direction." \" >RP Start Date</a></th>  ";
//echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=6&Direction=".$Direction." \" >Days in RP</a></th>  ";


echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=7&Direction=".$Direction." \" >IR Start Date</a></th>  ";

//echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=7&Direction=".$Direction." \" >Days in IR</a></th>  ";


echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=8&Direction=".$Direction." \" >CO Start Date</a></th>  ";

//echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=8&Direction=".$Direction." \" >Days in CO </a></th>  ";

echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=9&Direction=".$Direction." \" >FI Start Date</a></th>  ";

echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=14&Direction=".$Direction." \" >Total Days IR+FI</a></th>  ";

echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=14&Direction=".$Direction." \" >Standard</a></th>  ";

echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=14&Direction=".$Direction." \" >Module Type</a></th>  ";

echo "<th bgcolor=LightBlue ><a href=\"http:".$URL_str."/cmvp_show_details_mip_pareto.php?xLabel=".$xLabel."&startDate=".$startDate."&endDate=".$endDate."&OrderBy=14&Direction=".$Direction." \" >Security Level</a></th>  ";
