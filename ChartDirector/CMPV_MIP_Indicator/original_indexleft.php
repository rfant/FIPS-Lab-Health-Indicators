...
var charts = [
    ...
    ['CMVP_Active_By_Type_Pareto.php', "CMVP Active By Type Pareto", 0],
    ['CMVP_MIP_Pareto.php', "CMVP MIP Pareto", 0],
     ['CMVP_MIP_Trend_Forcast.php', "CMVP MIP Trend Forecast", 0],
    ['CMVP_Active_By_Type_Pie.php', "CMVP Active By Type Pie ", 3],

    ['stackedbar.php', "Stacked Bar Chart", 1],
    ['stackedbar_backup.php', "Beta Stacked Bar Chart", 1],
