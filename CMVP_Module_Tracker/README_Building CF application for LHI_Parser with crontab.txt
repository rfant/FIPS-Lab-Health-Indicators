...
cf create-service smb Existing LHI-SERVICE-INSTANCE -c "{\"share\":\"//FIPSLHI-DM.cps.intel.com/fs_FIPSLHI\",\"username\":\"ad_rfant@intel.com\",\"password\":\"icSox0317Ted-fant\", \"mount\":\"/var/vcap/data/LHI\"}"
...
1) delete fips-lab-parser app from CF Web based tool (from cloud portal website). Unbind/delete the LHI-SERVICE-INSTANCE 
