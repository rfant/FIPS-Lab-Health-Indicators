//Parser: This defines which postgresql database the parser will insert the new data
//Intel intranet
...
unsigned char plainTextPW[]={0x69, 0x63, 0x44, 0x75, 0x66, 0x39, 0x34, 0x47, 0x61, 0x65, 0x2D, 0, 0, 0, 0, 0, 0};
